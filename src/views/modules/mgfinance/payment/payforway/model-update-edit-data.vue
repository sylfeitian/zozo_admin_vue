    ...
    >
      ...
      >
        <el-form-item label="支付方式：" prop="paymentName">
          <el-input v-model.trim.trim="dataForm.paymentName" placeholder="请输入属性组名" readonly></el-input>
        </el-form-item>
        <el-form-item label="商户公众号APPID：" prop="appId">
          <el-input v-model.trim.trim="dataForm.appId" placeholder="1-255"></el-input>
        </el-form-item>
        <el-form-item label="Appsecret：" prop="secretKey">
          <el-input v-model.trim.trim="dataForm.secretKey" placeholder="1-255"></el-input>
        </el-form-item>
        <el-form-item label="商户号MCHID：" prop="paymentAccount">
          <el-input v-model.trim.trim="dataForm.paymentAccount" placeholder="1-255"></el-input>
        </el-form-item>
        <el-form-item label="商户API密钥：" prop="secretKeyApi">
          <el-input v-model.trim.trim="dataForm.secretKeyApi" placeholder="1-255"></el-input>
        </el-form-item>

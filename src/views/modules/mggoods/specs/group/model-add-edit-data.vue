		    	...
		    	<el-form
		    		...
		    		label-width="120px">
				        <el-form-item label="分组名称：" prop="groupName">
				        	  <el-input v-model="dataForm.groupName" maxlength="30" placeholder="请输入分组名称" show-word-limit></el-input>
				        </el-form-item>
		...
		methods:{
			...
			getSpecList(query){
			  	var obj = {
					page:1,
					limit:50,
					specName:query?query:'',
				}
				this.specLoading = true;
				specList(obj).then((res)=>{
					this.specLoading = false;
					var specOptions = [];
					// console.log("this.InitSpecOptions");
					// console.log(this.InitSpecOptions);
					if(res.code == 200 && res.data.list){
						specOptions =res.data.list;

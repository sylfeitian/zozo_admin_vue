		    	...
		    	<el-form
		    		...
		    		label-width="120px">
				        <el-form-item label="规格名称：" prop="specName">
				        	  <el-input v-model.trim.trim="dataForm.specName" maxlength="60" placeholder="请输入规格名称"></el-input>
				        </el-form-item>
						...
						<div  v-for="(item,index) in dataForm.specValueDTOList"  :key="index">
							<el-form-item label="规格值：" :prop="'specValue'+index">
								<el-input v-model.trim.trim="dataForm['specValue'+index]" placeholder="规格值" class="sepcInput" @input="changeSpec(index)" @change="changeSpec(index)"></el-input>

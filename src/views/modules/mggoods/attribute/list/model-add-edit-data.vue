		    	...
		    	<el-form
		    		...
		    		label-width="120px">
				        ...
				        <!-- <el-form-item label="排序:" prop="attrValueSort">
				        		 <el-input v-model.trim.trim="dataForm.attrValueSort" placeholder="请输入0-255,数字越大排序越靠前"></el-input>
				        </el-form-item> -->
						 <el-form-item label="属性值："  v-for="(item,index) in dataForm.attributeValueDTOList" :prop="'arrtibute'+index" :key="index">
				        	  <el-input v-model.trim.trim="dataForm['arrtibute'+index]" placeholder="属性值"  class="sepcInput" @input="changeArrtibute(index)" @change="changeArrtibute(index)"></el-input>

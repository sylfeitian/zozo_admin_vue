		    	...
		    	<el-form
		    		...
		    		label-width="120px">
				        <el-form-item label="品牌名称：" prop="brandName">
				        	  <el-input v-model="dataForm.brandName" maxlength="60" placeholder="请输入品牌名称"></el-input>
				        </el-form-item>
								<el-form-item label="品牌英文名称：" >
				        	  <el-input v-model="dataForm.brandNameEn" maxlength="60" placeholder="请输入品牌英文名称"></el-input>
				        </el-form-item>

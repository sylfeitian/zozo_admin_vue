		    		...
		    		label-width="130px">
				        <el-form-item label="商品类目：">
				         ...
				         <el-form-item label="商品规格：">
				        	 	 <span>{{dataForm.specAttrName.replace(/,/g,' - ')}}</span>
				        </el-form-item>
				        ...
				        <el-form-item label="sku名称：" prop="specName" style="width:90%">
                         ...
                         <el-form-item label="售价：" prop="specSellPrice">
                            <el-input-number v-model="dataForm.specSellPrice" :max="999999.99" :precision="2" :step="0.1" :min="0" placeholder="请输入"></el-input-number>
                            <span>元</span>
				        </el-form-item>

                         <el-form-item label="成本价：" prop="specCostPrice">
                            <el-input-number v-model="dataForm.specCostPrice" :max="999999.99" :precision="2" :step="0.1" :min="0"  placeholder="请输入"></el-input-number>
                            <span>元</span>
				        </el-form-item>

                        <el-form-item label="SKU库存：" prop="specStorage">
                            <el-input-number v-model="dataForm.specStorage"  :min="0"  placeholder="请输入"></el-input-number>
                            <span>件</span>
				        </el-form-item>

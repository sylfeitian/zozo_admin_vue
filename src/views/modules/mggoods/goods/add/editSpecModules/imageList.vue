<template>
    <div style="margin-left:-30px;">
       <div v-for="(item,index) in imgList" class="imgWarpList" >
            ...
            <div  v-if="item.imgListItem.length>0" class="pcCoverUrl imgUrl mainPic" @click="changeCurrentIndex(index,0)">
               <!-- :aspectRatio="1 / 1" -->
                <img-cropper
                  ref="cropperImg"
                  :index="'0'"
                  ...
                  :fontSize = "'90px'"
                  :lineHeight = "'160px'"
                  :cropImg='item.imgListItem[0].image | filterImgUrl'
                        ...
                        <!-- <img  :src="element.image" alt=""> -->
                          <div class="pcCoverUrl imgUrl" >
                               <div @click="changeCurrentIndex(index,index2)">
                                    ...
                                    :imgWidth='"100px"'
                                    :imgHeight='"100px"'
                                    :cropImg='element.image | filterImgUrl'
                                    @GiftUrlHandle="GiftUrlHandle"
                                  ></img-cropper>
            ...
            uploadPicBase64(params).then(res =>{
              ...
              if(res && res.code == "200"){
                ...
                if(that.currentIndex!=-1){
                  ...
                  if(that.imgList[that.groupIndex].imgListItem[len-1].image){

    ...
    <div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center">
            <template slot-scope="scope">
			        <!-- <el-input v-model.trim.trim="scope.row.specSellPrice" maxlength="30" placeholder="请输入" show-word-limit ></el-input> -->
          ...
          align="center">
            <template slot-scope="scope">
			        <!-- <el-input v-model.trim.trim="scope.row.specCostPrice" maxlength="30" placeholder="请输入" show-word-limit></el-input> -->
        ...
        <el-table-column
          ...
          align="center">
            <template slot-scope="scope">
			        <!-- <el-input v-model.trim.trim="scope.row.specStorage" maxlength="30" placeholder="请输入"  @change="changeInput"  @input="changeInput" show-word-limit></el-input> -->
        ...
        <el-table-column
          ...
          align="center">
            <template slot-scope="scope">
			        <!-- <el-input v-model.trim.trim="scope.row.specSerial" maxlength="30" placeholder="请输入"  @change="changeInput"  @input="changeInput" show-word-limit></el-input> -->

<template>
    ...
    >
        <el-table :data="dataList" border="" style="width: 100%">
            ...
            <el-table-column prop="" label="申报/合同单位"></el-table-column>
            <el-table-column prop="hsCode" label="HScode"></el-table-column>
            <el-table-column prop="" label="生成企业名称"></el-table-column>
            ...
            <el-table-column prop="" label="毛重(kg)"></el-table-column>
            <el-table-column prop="netWeight" label="净重(kg)"></el-table-column>
            <el-table-column prop="safeDays" label="保质期"></el-table-column>
            <el-table-column prop="" label="货物图片"></el-table-column>
            <el-table-column prop="shopStoreName" label="店铺名称"></el-table-column>
            <el-table-column prop="shopStoreId" label="商家ID"></el-table-column>
            <el-table-column prop="" label="商家联系方式"></el-table-column>
        </el-table>
    </el-dialog>
</template>

  ...
  <div>
    ...
    >
      ...
      <el-form-item label="商品名称：">
        <el-input v-model="dataFormShow.goodsName" placeholder="请输入商品名称" maxlength="300"></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="sellPrice" label="售价" width="100" align="center">
        <template slot-scope="scope">
          ...
          <div class="price1"  v-else>￥{{scope.row.sellPrice?scope.row.sellPrice:'0.00'}}</div>
        </template>
      </el-table-column>

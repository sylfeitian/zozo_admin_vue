<template>
    <div>
        ...
        <el-form :inline="true" class="grayLine topGapPadding" :model="dataForm" @keyup.enter.native="getDataList()" >
            ...
            <el-form-item>
                <el-button  class="btn" type="primary" @click="add()">搜索</el-button>
        ...
        >
            ...
            <el-table-column prop="japanDesc" label="发布人" align="center"></el-table-column>
            ...
            <el-table-column prop="desc" label="相关" align="center">
                <template slot-scope="scope">
                    <div class="priceWrap">
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button @click.native.prevent="add(scope.$index, scope.row)"type="text"size="mini">新增</el-button>

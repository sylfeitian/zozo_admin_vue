<template>
  <div class="adverClass">
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm"  @keyup.enter.native="submitStore()" label-width="130px">
        <el-form-item prop="relationId" label="商品分类类别：">
...
import { uploadPicBase64,adverDetail,classAdveSlect } from '@/api/api'
  ...
  // mixins: [mixinViewModule],
    data () {
        return {
            ...
            breaddata: ["运营", "广告管理", "分类广告列表",'分类广告编辑'],
            buttonStatus:false,
            subStatus:true,
            uploading:false,
            advId:null,

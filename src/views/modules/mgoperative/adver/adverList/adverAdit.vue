  ...
  <div class="adverList">
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm"  @keyup.enter.native="submitStore()" label-width="130px">
        <el-form-item prop="categoryId" label="广告类别：">
            <el-select v-model="dataForm.categoryId" clearable :disabled="advId?true:false"  placeholder="请选择">
                <el-option
        ...
        <el-form-item prop="advTitle" label="广告标题：">
            <el-input v-model.trim.trim="dataForm.advTitle" placeholder="" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="广告链接（URL）：">
            <el-input v-model.trim.trim="dataForm.relationTarget" placeholder="Http://xxxxxx.com" clearable @blur="urlChange"></el-input>
        </el-form-item>
...
import { uploadPicBase64,adverDetail,plainAdveSlect } from '@/api/api'
                    ...
                    adverDetail(obj).then((res)=>{
                        ...
                        if(res.code == 200){
                            ...
                            this.$nextTick(()=>{
                                ...
                                this.$refs.imageUrl.cropper.cropImg  = this.$imgDomain + res.data.imageUrl;
                            })

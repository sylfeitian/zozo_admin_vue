  ...
  <div>
    ...
    >
      <el-form-item label="等级名称：" prop="gradeName">
        <el-input v-model.trim.trim="dataForm.gradeName" placeholder="等级名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="changeTit" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form">
        <el-form-item label="等级名称：" :label-width="formLabelWidth" v-if="isChange">
          <el-input v-model.trim.trim="form.gradeName" autocomplete="off" style="width:61%" readonly></el-input>
        </el-form-item>
        <el-form-item label="等级名称：" :label-width="formLabelWidth" v-else prop="gradeName">
          <el-input v-model.trim.trim="form.gradeName" autocomplete="off" style="width:61%"></el-input>
        </el-form-item>
        <el-form-item label="等级分值：" :label-width="formLabelWidth" v-if="isChange">
          <el-input v-model.trim.trim="form.integration" autocomplete="off" style="width:30%" readonly></el-input>--
          <el-input v-model.trim.trim="form.maxIntegration" autocomplete="off" style="width:30%" readonly></el-input>
        </el-form-item>

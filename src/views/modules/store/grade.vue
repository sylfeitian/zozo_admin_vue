  ...
  <div>
    ...
    <el-form :inline="true" class="grayLine topGapPadding" :model="dataForm" @keyup.enter.native="getDataList()" >
        <el-form-item label="等级名称：">
            <el-input v-model="dataForm.sgName" placeholder="等级名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog
        ...
        <el-form :model="gradeDataForm" :rules="dataRule" ref="gradeDataForm" @keyup.enter.native="gradeSubmitHandle()" label-width="120px">
            ...
            <el-form-item label="商品数量：" prop="sgGoodsLimit">
                <el-input v-model="gradeDataForm.sgGoodsLimit" type="number" maxlength="6"></el-input>
            </el-form-item>
            <el-form-item label="收费标准：" prop="sgPrice">
                <el-input v-model="gradeDataForm.sgPrice" type="number" maxlength="5">
                    <template slot="append">人民币</template>
                </el-input>
            </el-form-item>
            <el-form-item label="佣金比例：" prop="brokerageScale">
                <el-input v-model="gradeDataForm.brokerageScale" type="number" maxlength="4">

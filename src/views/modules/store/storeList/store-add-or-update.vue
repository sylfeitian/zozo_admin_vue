      ...
      <div class="formMode">
        ...
        <div class="itemMode">
         ...
         <el-form-item label="电话：">
              <el-input v-model="dataForm.mobilePhone" clearable></el-input>
          </el-form-item>
      ...
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="商家名称：">
              <el-input v-model="dataForm.saveStoreDTO.storeName" placeholder="" clearable></el-input>
          </el-form-item>
      ...
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="公司名称：">
              <el-input v-model="dataForm.saveStoreAuthDTO.companyName" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="法人姓名：">
              <el-input v-model="dataForm.saveStoreAuthDTO.legalPersonName" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="办公电话：">
              <el-input v-model="dataForm.saveStoreAuthDTO.companyPhone" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          <el-form-item label="注册地址：">
              <el-input v-model="dataForm.saveStoreAuthDTO.companyAddress" placeholder="与注册证书地址一致" clearable></el-input>
          </el-form-item>
          <el-form-item label="办公地址：">
              <el-input v-model="dataForm.saveStoreAuthDTO.companyAddressDetail" placeholder="可以收发信件的有效地址" clearable></el-input>
          </el-form-item>
          <el-form-item label="注册资金：">
              <el-input v-model="dataForm.saveStoreAuthDTO.companyRegisteredCapital " placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          ...
          <el-form-item label="税号：">
              <el-input v-model="dataForm.saveStoreAuthDTO.taxpayerId" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>
      </div>
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="银行开户名称：">
              <el-input v-model="dataForm.saveStoreAuthDTO.bankAccountName " placeholder="开户行账号" clearable></el-input>
          </el-form-item>
          <el-form-item label="开户行名称：">
              <el-input v-model="dataForm.saveStoreAuthDTO.bankName " placeholder="开户行账号" clearable></el-input>
          </el-form-item>
          <el-form-item label="开户行账号：">
              <el-input v-model="dataForm.saveStoreAuthDTO.bankAccountNumber" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          <el-form-item label="支付宝姓名：">
              <el-input v-model="dataForm.saveStoreAuthDTO.alipayName " placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="支付宝账号：">
              <el-input v-model="dataForm.saveStoreAuthDTO.alipayAccountNumber" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>
        <div class="itemMode">
          <el-form-item label="微信姓名：">
              <el-input v-model="dataForm.saveStoreAuthDTO.wechatName " placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="微信账号：">
              <el-input v-model="dataForm.saveStoreAuthDTO.wechatAccountNumber" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>

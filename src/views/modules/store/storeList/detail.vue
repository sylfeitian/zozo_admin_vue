      ...
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item prop="account" label="登录账号：">
              <el-input v-model.trim.trim="dataForm.account" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item prop="password" label="密码：">
              <el-input v-model.trim.trim="dataForm.password" type="password" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
         <el-form-item label="电话：">
              <el-input v-model.trim.trim="dataForm.mobilePhone " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <!-- <div class="itemMode">
          <el-form-item label="性别：">
              <el-input v-model.trim.trim="dataForm.sex" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="电话：">
              <el-input v-model.trim.trim="dataForm.mobilePhone " placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="地址：">
              <el-input v-model.trim.trim="dataForm.paramCode" placeholder="" clearable></el-input>
          </el-form-item>
        </div> -->
      </div>
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="商家名称：">
              <el-input v-model.trim.trim="dataForm.saveStoreDTO.storeName" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="店铺等级：">
              <!-- <el-input v-model.trim.trim="dataForm.saveStoreDTO.gradeId" :disabled="true" placeholder="" clearable></el-input> -->
        ...
        <div class="itemMode">
          <el-form-item label="经营范围：">
              <!-- <el-input v-model.trim.trim="dataForm.storeClassId" :disabled="true" placeholder="" clearable></el-input> -->
      ...
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="公司名称：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.companyName" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="法人姓名：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.legalPersonName" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="办公电话：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.companyPhone" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          <el-form-item label="注册地址：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.companyAddress" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="办公地址：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.companyAddressDetail" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="注册资金：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.companyRegisteredCapital " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          ...
          <el-form-item label="税号：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.taxpayerId" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>
      </div>
      <div class="formMode">
        ...
        <div class="itemMode">
          <el-form-item label="银行开户名称：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.bankAccountName " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="开户行名称：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.bankName " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="开户行账号：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.bankAccountNumber" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
        </div>
        <div class="itemMode">
          <el-form-item label="支付宝姓名：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.alipayName " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="支付宝账号：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.alipayAccountNumber" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>
        <div class="itemMode">
          <el-form-item label="微信姓名：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.wechatName " :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <el-form-item label="微信账号：">
              <el-input v-model.trim.trim="dataForm.saveStoreAuthDTO.wechatAccountNumber" :disabled="true" placeholder="" clearable></el-input>
          </el-form-item>
          <div style="width:392px"></div>
        </div>
        <div class="itemMode">

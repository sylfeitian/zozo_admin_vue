  ...
  <div>
    ...
    >
      ...
      <el-form-item label="搜索会员账号：">
        <el-input v-model="dataForm.memberName" placeholder="请输入会员账号搜索"></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="memberName" label="搜索会员账号" align="center"></el-table-column>
...
import {
  shophotkeywordrecordUrl,
  deleteShophotkeywordrecordUrl
} from "@/api/url";
export default {

    ...
    >
        ...
        >
            <el-form-item label="字典名称：" prop="dictName" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.dictName" auto-complete="off" placeholder="请输入"></el-input>
            </el-form-item>
            <el-form-item label="字典编码：" prop="dictValue" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.dictValue" auto-complete="off" show-word-limit placeholder="请输入"></el-input>
            </el-form-item>

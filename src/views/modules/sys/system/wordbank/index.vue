    ...
    <div>
        ...
        <div class="mod-sys__user">
            ...
            <el-table
                ...
                <el-table-column prop="chineseVocabulary" label="API接口翻译中文" header-align="center" align="center"></el-table-column>
                <el-table-column prop="japaneseWord" label="对照翻译中文" header-align="center" align="center"></el-table-column>

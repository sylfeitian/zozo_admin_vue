        ...
        <div class="mod-sys__user">
            <el-form :inline="true" :model="dataForm" class="grayLine" @keyup.enter.native="getData()">
                <el-form-item label="中文词汇：">
                    <el-input v-model="dataForm.username" placeholder="请输入中文搜索" clearable></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table
                ...
                <el-table-column prop="" label="中文词汇" header-align="center" align="center"></el-table-column>
                <el-table-column prop="" label="对照日文词汇" header-align="center" align="center"></el-table-column>

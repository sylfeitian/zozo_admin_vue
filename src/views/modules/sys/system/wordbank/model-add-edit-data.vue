    ...
    >
        ...
        >
            <el-form-item label="中文词汇：" prop="chineseVocabulary" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.chineseVocabulary" placeholder="请输入"></el-input>
            </el-form-item>
            <el-form-item label="对照词汇：" prop="japaneseWord" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.japaneseWord" placeholder="请输入"></el-input>
            </el-form-item>

    ...
    <div class="mod-sys__dict">
      <el-form :inline="true" :model="dataForm" class="grayLine" @keyup.enter.native="getDataList()">
        <el-form-item label="名称：">
          <el-input v-model.trim.trim="dataForm.dictName" :placeholder="$t('dict.dictName')" clearable></el-input>
        </el-form-item>
        <el-form-item v-if="dataForm.pid === '0'" label="类型：">
          <el-input v-model.trim.trim="dataForm.dictType" :placeholder="$t('dict.dictType')" clearable></el-input>
        </el-form-item>
        <el-form-item v-if="dataForm.pid !== '0'" label="值：">
          <el-input v-model.trim.trim="dataForm.dictValue" :placeholder="$t('dict.dictValue')" clearable></el-input>
        </el-form-item>
        <el-form-item>

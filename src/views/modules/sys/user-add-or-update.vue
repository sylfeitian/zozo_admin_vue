  ...
  <el-dialog :visible.sync="visible" :title="!pageId ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmitHandle()" label-width="120px">
      <el-form-item prop="username" :label="$t('user.username') + '：'">
        <el-input v-model.trim.trim="dataForm.username" :placeholder="$t('user.username')"></el-input>
      </el-form-item>
      <!-- <el-form-item prop="deptName" :label="$t('user.deptName') + '：'" class="dept-list">
        ...
        <el-input v-model.trim.trim="dataForm.deptName" v-popover:deptListPopover :readonly="true" :placeholder="$t('user.deptName')"></el-input>
      </el-form-item> -->
      <el-form-item prop="password" :label="$t('user.password') + '：'" :class="{ 'is-required': !pageId }">
        <el-input v-model.trim.trim="dataForm.password" type="password" :placeholder="$t('user.password')"></el-input>
      </el-form-item>
      <el-form-item prop="comfirmPassword" :label="$t('user.comfirmPassword') + '：'" :class="{ 'is-required': !pageId }">
        <el-input v-model.trim.trim="dataForm.comfirmPassword" type="password" :placeholder="$t('user.comfirmPassword')"></el-input>
      </el-form-item>
      <el-form-item prop="realName" :label="$t('user.realName') + '：'">
        <el-input v-model.trim.trim="dataForm.realName" :placeholder="$t('user.realName')"></el-input>
      </el-form-item>
      ...
      <el-form-item prop="email" :label="$t('user.email') + '：'">
        <el-input v-model.trim.trim="dataForm.email" :placeholder="$t('user.email')"></el-input>
      </el-form-item>
      <el-form-item prop="mobile" :label="$t('user.mobile') + '：'">
        <el-input v-model.trim.trim="dataForm.mobile" :placeholder="$t('user.mobile')"></el-input>
      </el-form-item>

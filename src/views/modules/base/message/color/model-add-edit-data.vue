<template>
    ...
    >
        ...
        >
            ...
            <el-form-item label="日本颜色名称：">
                <span>{{dataForm.nameJp}}</span>
            </el-form-item>
            <el-form-item label="颜色名称：" prop="name" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.name" auto-complete="off"></el-input>
            </el-form-item>

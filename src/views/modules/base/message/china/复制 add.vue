<template>
	<!--新增的弹窗-->
        ...
        <el-form-item label="分类名称：" prop="name">
            <el-input v-model.trim="dataForm.name " type="text" placeholder="请输入4个汉字/8个字符以内的内容" show-word-limit style="width:400px;"></el-input>
        </el-form-item>
        ...
        <el-form-item v-if="yijishow" v-for="(item, index) in dataForm.categoryJpId" :key="index" :label="index == 0 ? '关联日本分类：' : '' ">
	 	...
	 	<el-form-item label="评价类型：" prop="appraisal" v-if="erjishow">
	        <el-input v-model.trim="dataForm.appraisal" type="text" maxlength="6" placeholder="请输入6字以内的内容" show-word-limit style="width:400px;"></el-input>
	    </el-form-item>

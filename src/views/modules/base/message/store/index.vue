  ...
  <div>
    ...
    >
      <el-form-item label="店铺ID：">
        <el-input v-model.trim.trim="dataFormShow.idJp" placeholder="请输入" maxlength="30" ></el-input>
      </el-form-item>
      <el-form-item label="店铺名称：">
        <el-input v-model.trim.trim="dataFormShow.stName" placeholder="请输入"></el-input>
      </el-form-item>

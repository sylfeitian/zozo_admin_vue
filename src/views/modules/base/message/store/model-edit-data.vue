    ...
    >
        ...
        >
            ...
            <el-form-item label="店铺中文名称：" prop="storeName">
                <el-input v-model.trim.trim="dataForm.storeName" placeholder="请输入"></el-input>
            </el-form-item>
...
<!--                <el-input v-model.trim.trim="dataForm.description" placeholder="" style="width: 250px;"></el-input>&nbsp;-->

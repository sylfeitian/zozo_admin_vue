  ...
  <div>
    ...
    <el-form :inline="true" class="grayLine topGapPadding" :model="dataForm" @keyup.enter.native="getDataList()" >
        <el-form-item label="活动名称：">
            <el-input v-model.trim.trim="dataForm.title" placeholder="请输入优惠券名称" clearable  maxlength="300" ></el-input>
        </el-form-item>
...
import { presellActivityPage,deletePresellActivity } from '@/api/url'
  ...
  data () {
    return {
      mixinViewModuleOptions: {
          getDataListURL: presellActivityPage,
          getDataListIsPage: true,
          exportURL: '/admin-api/store/export',
          deleteURL:deletePresellActivity,
          deleteIsBatch: true,
          deleteIsBatchKey: 'id'
      },

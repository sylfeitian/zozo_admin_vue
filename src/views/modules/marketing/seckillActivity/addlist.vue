        ...
        >
            ...
            >
                ...
                >
                    ...
                    <el-table-column prop="storeName" label="规格"></el-table-column>
                    <el-table-column label="活动库存">
                        <template slot-scope="scope">
                            <el-input v-model="kucun" :maxlength="6" type="number"></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column prop="gradeName" label="日本限购数量"></el-table-column>
                    <el-table-column prop="createDate" label="每人限购" width="180">
                        <template slot-scope="scope">
                            <el-input v-model="kucun" :maxlength="6" type="number"></el-input>
                        </template>
                    </el-table-column>
...
import { backScanCategorys, addSckillPro } from "@/api/api";

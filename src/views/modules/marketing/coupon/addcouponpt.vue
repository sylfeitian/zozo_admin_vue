<template>
  <div>
        ...
        <el-form-item label="总发行量：" prop="totalNums">
            <el-input v-model.trim.trim="dataForm.totalNums" type="text" min="0"  max="1000000" placeholder="1000"  style="width:400px;"></el-input>
        </el-form-item>
        ...
        <el-form-item class="artfromitem" label="每人限领：" prop="limitNum">
            <el-input v-model.trim.trim="dataForm.limitNum" type="text"  max="1000000" placeholder="1"  style="width:400px;"></el-input>

    ...
    <div>
        <el-form :model="dataForm" label-width="140px" :rules="dataRule" class="demo-ruleForm" ref="addForm">
            <el-form-item label="优惠券名称：" prop="name">
                <el-input v-model.trim.trim="dataForm.name" type="text" placeholder="请输入50字以内的内容" style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="所需积分：" prop="memberPoints">
                <el-input v-model.trim.trim="dataForm.memberPoints" type="text" min="0" max="1000000" placeholder="1000"
                          style="width:400px;"></el-input>
            </el-form-item>
            <el-form-item label="总发行量：" prop="totalNums">
                <el-input v-model.trim.trim="dataForm.totalNums" type="text" min="0" max="1000000" placeholder="1000"
                          style="width:400px;"></el-input>
            </el-form-item>
            ...
            <el-form-item class="artfromitem" label="使用门槛：" prop="threshold">
                <div>单笔订单满</div>
                <el-input v-model.trim.trim="dataForm.threshold" type="text" max="1000000" placeholder="0"
                          style="width:400px;"></el-input>
                <div>元可用（输入“0”为无门槛优惠券）</div>
            </el-form-item>
            <el-form-item class="artfromitem" label="每人限领：" prop="limitNum">
                <el-input v-model.trim.trim="dataForm.limitNum" type="text" max="1000000" placeholder="1"
                          style="width:400px;"></el-input>
                <div>张 &nbsp;&nbsp;&nbsp;&nbsp; 0代表不限制，每人最多限制5张</div>
            </el-form-item>
            <el-form-item label="有效期：" prop="totalNums">
                <!--            <el-input v-model.trim.trim="dataForm.totalNums" type="number"  max="1000000" placeholder="1000"  style="width:400px;"></el-input>-->

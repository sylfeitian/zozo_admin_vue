<template>
  <div>
    ...
    <add-coupon-jf v-if="editSatusId&&editType == '积分优惠券'" :editSatusId="editSatusId" @changePage = "changePage"></add-coupon-jf>
    ...
    <el-tabs v-if="!editSatusId" v-model="activeName2" type="card" @tab-click="handleClick">
	    ...
	    <el-tab-pane label="积分优惠券" name="second">
	    	<add-coupon-jf :type="type" v-if="showLable == '积分优惠券'" @changePage = "changePage"></add-coupon-jf>
	    </el-tab-pane>

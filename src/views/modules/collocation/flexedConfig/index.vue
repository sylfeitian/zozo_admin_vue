        ...
        <div class="modle">
            ...
            <div class="modleItem">
                <el-form :model="dataForm1">
                    当库存大于<el-input style="width:220px;" type="number" :maxlength="6" show-word-limit v-model="dataForm1.inventory" placeholder="请输入请输入数字" clearable></el-input>显示<span style="color:red;">有库存</span>，反之显示库存较少
                </el-form>
                <div class="btns1">
            ...
            <div class="modleItem">
                <el-form :model="dataForm2" label-width="70px">
                    <el-form-item label="文案："> 
                        <el-input type="textarea" :rows="10" :maxlength="1000" show-word-limit placeholder="请输入内容" v-model="dataForm2.copywriting"> </el-input>
                    </el-form-item>
        ...
        <div class="modle">
            ...
            <div class="modleItem">
                <el-form :model="dataForm3" label-width="70px">
                    <el-form-item label="文案："> 
                        <el-input type="textarea" :rows="10" :maxlength="1000" show-word-limit placeholder="请输入内容" v-model="dataForm3.copywriting"> </el-input>
                    </el-form-item>
                    <el-form-item label="是否显示：">
            ...
            <div class="modleItem">
                <el-form :model="dataForm4" label-width="70px">
                    <el-form-item label="全部：">
                        <el-input v-model="dataForm4.all" placeholder="请输入50字以内内容" :maxlength="50" show-word-limit clearable></el-input>
                    </el-form-item>
                    <el-form-item label="男：">
                        <el-input v-model="dataForm4.man" placeholder="请输入50字以内内容" :maxlength="50" show-word-limit clearable></el-input>
                    </el-form-item>
                    <el-form-item label="女：">
                        <el-input v-model="dataForm4.woman" placeholder="请输入50字以内内容" :maxlength="50" show-word-limit clearable></el-input>
                    </el-form-item>
                    <el-form-item label="儿童：">
                        <el-input v-model="dataForm4.child" placeholder="请输入50字以内内容" :maxlength="50" show-word-limit clearable></el-input>
                    </el-form-item>
                </el-form>

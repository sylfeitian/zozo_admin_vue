  ...
  <div>
    ...
    <el-form :inline="true" class="grayLine topGapPadding" :model="dataForm" @keyup.enter.native="getDataList()" >
        <el-form-item label="轮播图名称：">
            <el-input v-model.trim.trim="dataForm.name" placeholder="请输入轮播图名称" clearable></el-input>
        </el-form-item>
    ...
    <el-dialog
        ...
        <el-form :model="activiDataForm" :rules="dataRule" ref="activiDataForm" @keyup.enter.native="subActivity()" label-width="120px">
            ...
            <el-form-item label="轮播图名称：" prop="name">
                <el-input v-model.trim.trim="activiDataForm.name" placeholder="请输入30字以内的名称"></el-input>
            </el-form-item>
            <el-form-item label="排序：">
                <el-input v-model.trim.trim="activiDataForm.sort" placeholder="数字越大排序越靠前" maxlength="6"></el-input>
            </el-form-item>
            ...
            <el-form-item label="链接：" v-if="activiDataForm.linkType == '3'" prop="linkUrl">
                <!-- <el-input v-model.trim.trim="activiDataForm.linkUrl"></el-input> -->
                <el-input
                    type="textarea"
                    placeholder="请输入链接"
    ...
    <el-dialog
        ...
        <el-form :inline="true" :model="goodsdataForm">
            <el-form-item label="商品名称：">
                <el-input v-model.trim.trim="goodsdataForm.goodsName" placeholder="商品名称/商品货号" clearable maxlength="300"></el-input>
            </el-form-item>

    ...
    <div>
        ...
        <el-form :inline="true" :model="dataForm" class="demo-form-inline grayLine" ref="dataForm">
            <el-form-item label="用户ID/手机号/名称：" prop="memberId" clearable>
                <el-input v-model.trim.trim="dataForm.memberId" placeholder="用户ID/手机号/名称"></el-input>
            </el-form-item>
        ...
        <el-table :data="dataList" border="" style="width: 100%">
          <el-table-column
            ...
            <el-table-column prop="loginName" label="名称" width="150"></el-table-column>

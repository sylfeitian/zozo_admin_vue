  ...
  <el-dialog title="会员编辑" :visible.sync="outerVisible" @click="goBack" :show-close="false">
    ...
    >
      <el-form label-width="100px" :rules="rules" ref="form" :model="form">
        ...
        <el-form-item label="请输入" prop="phone">
          <el-input v-model.trim.trim="form.phone" placeholder="请输入接受短信的手机号"></el-input>
        </el-form-item>
    ...
    <el-form label-width="100px" :model="dataForm">
      <el-form-item label="名称：">
        <el-input v-model.trim.trim="memberInfo.nickName"></el-input>
      </el-form-item>
      <el-form-item label="密码：">
        <el-input v-model.trim.trim="memberInfo.memberPasswd">******</el-input>
        <span class="rest" @click="innerVisible = true">重置密码</span>
      </el-form-item>
      <el-form-item label="备注：">
        <el-input v-model.trim.trim="form.name"></el-input>
      </el-form-item>

    ...
    >
        ...
        >
            <el-form-item label="仓库名称：" prop="warehouseName">
                <el-input v-model.trim.trim="dataForm.warehouseName" placeholder="请输入"></el-input>
            </el-form-item>
            ...
            <el-form-item label="仓库负责人：" prop="name">
                <el-input v-model.trim.trim="dataForm.name" placeholder="请输入"></el-input>
            </el-form-item>
            <el-form-item label="负责人联系方式：" prop="phone" :label-width="formLabelWidth">
                <el-input v-model.trim.trim="dataForm.phone" placeholder="请输入" maxlength="20"></el-input>
            </el-form-item>

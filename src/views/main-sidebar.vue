<template>
  <aside :class="['aui-sidebar', `aui-sidebar--${$store.state.sidebarLayoutSkin}`,$store.state.sidebarFold ? 'aui-sidebar1' : 'aui-sidebar2']">
      <div class="aui-sidebar__inner">
        <el-menu
          ...
          <el-menu-item index="home" @click="$router.push({ name: 'home' })" v-if="parentItem.children.length==0"   class="lileve2">
              <div>
      ...
      <el-menu class="aui-navbar__menu mr-auto  bottomContraction" mode="horizontal">
          ...
          <el-menu-item index="1" @click="$store.state.sidebarFold = !$store.state.sidebarFold">
            ...
            <div :class="$store.state.sidebarFold?'sidebarFoldTrue':'sidebarFoldFalse'">
...
.bottomContraction{
   ...
   .el-icon-arrow-down:before {
    ...
    .sidebarFoldTrue,.sidebarFoldFalse{
      width:38px;
      height:36px;
